...
// Math.random(): This function generates a random floating-point number in the range [0, 1). It returns a number greater than or equal to 0 but less than 1.

// Math.random() * myquotes.length: This part scales the random number to the size of myquotes array. The result will be a decimal number in the range [0, myquotes.length).

// Math.floor(): This function rounds down a floating-point number to the nearest integer. It ensures that you get a whole number.

// The combined effect of these operations is to get a random integer index within the bounds of your myquotes array.

// let quote = myquotes[index].quote;

let quote = myquotes[index].quote;


// myquotes[index]: This accesses the array element at the randomly generated index. It retrieves a quote object from your myquotes array.

// .quote: This accesses the quote property of the quote object. It gets the actual quote string.

document.getElementById("quote-box").innerHTML = `<p>"${quote}"</p>`;
